  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <section className="relative h-[650px] w-full overflow-hidden flex items-center">
        ...
        <div className="container mx-auto px-6 relative z-10 text-white max-w-4xl text-center md:text-left">
          ...
          <h1 className="text-5xl md:text-7xl font-bold tracking-tight mb-6 animate-in fade-in slide-in-from-bottom-6 duration-700">
            Taste the Magic of{" "}
            <span className="text-orange-500 italic">Zaika Zone</span>
          </h1>
          <p className="text-lg md:text-xl text-zinc-200 mb-8 max-w-2xl animate-in fade-in slide-in-from-bottom-8 duration-1000">
            Discover a world of exquisite flavors and artisanal dishes prepared
            with the finest ingredients. From local favorites to international
            delicacies, we bring the best to your table.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 animate-in fade-in slide-in-from-bottom-10 duration-1000 delay-200">
            <Button
              size="lg"
              className="bg-orange-500 hover:bg-orange-600 text-white font-semibold h-12 px-8 rounded-xl shadow-lg shadow-orange-500/20"
            >
              Explore Menu
            ...
            <Button
              size="lg"
              variant="outline"
              className="border-white/20 bg-white/10 text-white backdrop-blur-md hover:bg-white/20 h-12 px-8 rounded-xl"
            >
              Our Story
            </Button>
          </div>
      ...
      <section className="py-24 bg-white dark:bg-zinc-950">
        <div className="container mx-auto px-6">
          <div className="text-center max-w-2xl mx-auto mb-16">
            <h2 className="text-3xl font-bold text-zinc-900 dark:text-white mb-4 italic">
              Experience the Zaika Difference
            </h2>
            <p className="text-zinc-500 dark:text-zinc-400">
              We pride ourselves on delivering not just food, but an
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div
                key={idx}
                className="p-8 rounded-3xl border border-zinc-100 dark:border-zinc-800 bg-zinc-50/50 dark:bg-zinc-900/50 hover:shadow-xl transition-all duration-300 group"
              >
      ...
      <section className="py-24 bg-orange-500 flex flex-col items-center justify-center text-center px-6">
        <h2 className="text-4xl font-bold text-white mb-6 animate-in zoom-in duration-500">
          Ready to taste the excellence?
        </h2>
        <p className="text-orange-100 mb-10 max-w-xl">
          Join thousands of food lovers who experience the magic of Zaika Zone
          every day.
        </p>
        <Link to="/signup">
          <Button
            size="lg"
            className="bg-white text-orange-600 hover:bg-orange-50 h-14 px-10 rounded-2xl font-bold text-lg shadow-xl translate-y-0 active:translate-y-px transition-all"
          >
            Join Now - It's Free
          </Button>
        </Link>
